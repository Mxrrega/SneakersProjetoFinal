...
namespace SneakersProjetoFinal.Controllers
{
    public class CadastroController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,NomeCadastro,EmailCadastro,CPFCadastro,Senha")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,NomeCadastro,EmailCadastro,CPFCadastro,Senha")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
